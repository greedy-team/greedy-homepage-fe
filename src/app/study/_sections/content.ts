...
export const PAGE = {
  ...
  note: "커리큘럼은 기수마다 조금씩 달라져요. 가장 최근 기수 기준이에요.",
} as const;
...
export const TRACKS: Track[] = [
  {
    ...
    label: "프론트엔드",
    title: "프론트엔드 트랙",
    // 줄바꿈은 화면 폭이 아니라 문장 단위로 끊어요 (whitespace-pre-line으로 그대로 살아요)
    description:
      "사용자가 보고 만지는 화면을 만들어요. 자바스크립트 3주와 리액트 11주, 총 14주 미션을 지나면 서버에서 렌더링하는 방법까지 다루게 돼요.\n초록스터디 자료와 그리디가 직접 만든 자료로 진행해요.",
  ...
  },
  {
    ...
    title: "백엔드 트랙",
    description:
      "화면 뒤에서 데이터를 다루는 서버를 만들어요. 자바 5주와 스프링 9주, 총 14주 미션을 지나면 인증부터 배포까지 직접 해보게 돼요.\n초록스터디 자료와 그리디가 직접 만든 자료로 진행해요.",
    ...
    curriculum: [
      ...
      {
        weeks: "6~8주차",
        title: "스프링 입문 Level 1",
        mission: "MVC, JDBC",
        description: "웹 요청이 처리되는 흐름을 만들고 데이터베이스를 연결해요.",
      },
      {
        weeks: "9주차",
        title: "스프링 입문 Level 2",
        mission: "Core, Layered Architecture",
        description: "스프링이 객체를 관리하는 방식과 계층 분리를 이해해요.",
      },
      {
        weeks: "10~13주차",
        title: "스프링 기초 Level 1",
        mission: "인증, JPA",
        description: "인증과 JPA로 로그인과 데이터를 다루는 법을 익혀요.",
      },
      {
        weeks: "14주차",
        title: "스프링 기초 Level 2",
        mission: "배포",
        description: "만든 서버를 실제 환경에 배포해요.",
      },
    ],
  },
];
