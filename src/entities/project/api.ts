...
const PROJECTS: Project[] = [
  {
    ...
    purpose:
      "학사일정과 두드림 공지가 서로 다른 곳에 흩어져 있어 매번 사이트를 찾아가야 하고, 관심사대로 거르거나 캘린더에 넣기도 번거로워요.\n공지를 자동으로 모으고 학과·키워드·학년 조건을 반영한 구독 주소를 발급해, 캘린더에서 자동으로 동기화되게 해요.",
    mainFunction: [
  ...
  },
  {
    ...
    purpose:
      "약속을 잡을 때 시간 조율은 여기저기 흩어져 있고, 장소가 특정 사람에게만 가까워 이동이 불공평해지기 쉬워요.\n참여자들의 가능한 시간과 출발지를 모아 대중교통 이동시간과 기하중심을 계산해, 최적의 시간과 공평한 장소를 추천해요.",
    mainFunction: [
  ...
  },
  {
    ...
    purpose:
      "캠퍼스에서 잃어버린 물건은 에브리타임 글에 묻히기 쉬워요.\n어디서 발견됐는지 한눈에 볼 방법이 없었어요.\n분실물을 지도 위에 표시해 잃어버린 물건과 주인을 더 빠르게 이어줘요.",
    mainFunction: [
  ...
  },
  {
    ...
    purpose:
      "학교 주변이 익숙하지 않거나 자주 가는 곳이 한정된 세종대생은 분위기나 단체 가능 여부 같은 실용 정보를 얻기 어려워요.\n세종대생만 장소와 리뷰를 남길 수 있게 해서, 세종대생이 함께 만드는 장소 서비스를 제공해요.",
    mainFunction: [
  ...
  },
  {
    ...
    purpose:
      "동아리는 에브리타임에 홍보글을 올려도 금방 묻혀 알리기 어렵고, 학우는 어떤 동아리가 있는지 한 번에 보기 어려워요.\n흩어진 동아리 홍보와 정보 탐색을 한곳에 모아 풀어요.",
    mainFunction: [
  ...
  },
  {
    ...
    purpose:
      "유튜브 여행 브이로그를 보며 '저 코스 그대로 가보고 싶다'는 마음은 들지만, 영상 속 장소를 일일이 찾아 정리하고 동선을 짜기는 번거로워요.\n인기 여행 영상의 장소와 동선을 자동으로 정리해 바로 따라갈 수 있게 해줘요.",
    mainFunction: [
